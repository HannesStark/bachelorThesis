...
\title{Latent Representation of Topographic adsf asdfClasses in Remote Sensing Image Data using Autoencoders}
\author{Hannes Stärk}
\programname{Informatik}
\placeofstudy{Neubiberg}
...
\coursetitle{Visual Computingsasasfkhk} 
\advisor{Wolfgang Brandenburger}
