...
z = tf.keras.layers.Conv2D(64, strides=2, kernel_size=5, padding="same", activation="selu")(z)
z = tf.keras.layers.Conv2D(128, strides=2, kernel_size=5, padding="same", activation="selu")(z)
...
x = tf.keras.layers.Dense(4 * 4 * 128)(decoder_inputs)
...
x = tf.keras.layers.Conv2DTranspose(32, kernel_size=5, strides=2, padding="same", activation="selu")(x)
