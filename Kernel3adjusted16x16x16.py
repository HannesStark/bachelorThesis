...
z = tf.keras.layers.Conv2D(4, strides=2, kernel_size=3, padding="same", activation="selu")(inputs)
z = tf.keras.layers.Conv2D(8, strides=2, kernel_size=3, padding="same", activation="selu")(z)
...
x = tf.keras.layers.Dense(16 * 16 * 16)(decoder_inputs)
...
x = tf.keras.layers.Conv2DTranspose(4, kernel_size=3, strides=2, padding="same", activation="selu")(x)
