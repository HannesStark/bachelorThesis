...
\subsubsection{Pure Convolutional Architecture}
...
\begin{figure}[h]
    ...
    refers to the sampling as described in section \ref{vae_background}.} \label{figure_pure_convolutional_encoder}
\end{figure}
